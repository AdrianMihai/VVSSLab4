...
public class Main {
    public static void main(String[] args) throws IOException {
        StudentRepo rep = new StudentRepo(new StudentValidator(), "src\\main\\java\\MaxPointsParticipantsMV\\studenti.xml");
        TemeRepo repo = new TemeRepo(new TemeValidator(), "src\\main\\java\\MaxPointsParticipantsMV\\teme.xml");
